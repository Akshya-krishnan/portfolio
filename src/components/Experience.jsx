...
function Experience() {
  ...
  useEffect(() => {
    ...
    ref.current?.querySelectorAll(".tl-item, .reveal").forEach((el) => obs.observe(el));
  }, []);
  ...
  return (
    <section className="experience" id="experience" ref={ref}>
      <div className="container">
        ...
        <p className="sec-sub reveal reveal-delay-2">Professional roles where I've built real-world products and grown as a developer.</p>
        <div className="timeline">
          {experiences.map((exp, i) => (
            <div className={`tl-item reveal-delay-${i}`} key={exp.company}>
              <div className="tl-dot" style={i === 1 ? { background: "var(--accent2)" } : {}} />
              <div className="tl-header">
                <img src={exp.logo} alt={exp.company} className="tl-logo"
                  onError={(e) => { e.target.src = `https://ui-avatars.com/api/?name=${exp.company[0]}&background=1a2336&color=4f8ef7&size=48`; }} />
                <div>
              ...
              <div className="tl-links">
                <a href={exp.cert} target="_blank" rel="noreferrer" className="tl-link tl-cert">
                  <FaCertificate /> Certificate
                </a>
                <a href={exp.web} target="_blank" rel="noreferrer" className="tl-link tl-ref">
                  <FaGlobe /> Website
                </a>
                <a href={exp.insta} target="_blank" rel="noreferrer" className="tl-link tl-ref">
